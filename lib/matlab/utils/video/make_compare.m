function make_compare(img_dir, pred_dir1, pred_dir2, vid_dir, vid_name, frame_rate, quality)
    ...
    pred_list1 = dir([pred_dir1 '/*.png']);
    pred_list2 = dir([pred_dir2 '/*.png']);
    ...
    for idx_frame = 1:num_frame
        ...
        pred1 = insertText(pred1, [12 6], 'CASENet', 'FontSize', 30, 'TextColor', [0 0 255], 'BoxOpacity', 0);
        pred2 = insertText(pred2, [12 6], 'SEAL', 'FontSize', 30, 'TextColor', [0 0 255], 'BoxOpacity', 0);
