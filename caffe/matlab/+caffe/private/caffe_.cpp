...
// Added by Zhiding
// Usage: caffe_('solver_iter_start', hSolver)
static void solver_iter_start(MEX_ARGS) {
  mxCHECK(nrhs == 1 && mxIsStruct(prhs[0]),
      "Usage: caffe_('solver_iter_start', hSolver)");
  Solver<float>* solver = handle_to_ptr<Solver<float> >(prhs[0]);
  solver->IterStart();
...
// Added by Zhiding
// Usage: caffe_('solver_iter_init', hSolver)
static void solver_iter_init(MEX_ARGS) {
  mxCHECK(nrhs == 1 && mxIsStruct(prhs[0]),
      "Usage: caffe_('solver_iter_init', hSolver)");
  Solver<float>* solver = handle_to_ptr<Solver<float> >(prhs[0]);
  solver->IterInit();
...
// Added by Zhiding
// Usage: caffe_('solver_iter_run', hSolver)
static void solver_iter_run(MEX_ARGS) {
  mxCHECK(nrhs == 1 && mxIsStruct(prhs[0]),
      "Usage: caffe_('solver_iter_run', hSolver)");
  Solver<float>* solver = handle_to_ptr<Solver<float> >(prhs[0]);
  solver->IterRun();
...
// Added by Zhiding
// Usage: caffe_('solver_iter_update', hSolver)
static void solver_iter_update(MEX_ARGS) {
  mxCHECK(nrhs == 1 && mxIsStruct(prhs[0]),
      "Usage: caffe_('solver_iter_update', hSolver)");
  Solver<float>* solver = handle_to_ptr<Solver<float> >(prhs[0]);
  solver->IterUpdate();
...
static handler_registry handlers[] = {
  ...
  { "solver_iter_start",  solver_iter_start},
  { "solver_iter_init",   solver_iter_init},
  { "solver_iter_run",    solver_iter_run },
  { "solver_iter_update", solver_iter_update},
  { "get_net",            get_net         },
