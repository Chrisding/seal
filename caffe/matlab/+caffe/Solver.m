classdef Solver < handle
  ...
  methods
    ...
    function IterStart(self) % added by Zhiding
      caffe_('solver_iter_start', self.hSolver_self);
    end
    function IterInit(self) % added by Zhiding
      caffe_('solver_iter_init', self.hSolver_self);
    end
    function IterRun(self) % added by Zhiding
      caffe_('solver_iter_run', self.hSolver_self);
    end
    function IterUpdate(self) % added by Zhiding
      caffe_('solver_iter_update', self.hSolver_self);
    end
  end
end
